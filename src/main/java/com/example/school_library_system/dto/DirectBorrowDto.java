...
public class DirectBorrowDto {
    ...
    private Integer borrowMinutes = 0;
    ...
    public Integer getBorrowMinutes() { return borrowMinutes; }
    public void setBorrowMinutes(Integer borrowMinutes) { this.borrowMinutes = borrowMinutes; }
