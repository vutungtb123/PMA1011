...
CREATE TABLE BorrowRecords (
    ...
    BorrowDate         DATETIME2     NULL,           -- NULL khi "Đã đặt chỗ", điền khi admin xác nhận
    DueDate            DATETIME2     NULL,           -- NULL khi "Đã đặt chỗ", điền khi admin xác nhận
    RecordStatus       NVARCHAR(50)  NULL DEFAULT N'Đã đặt chỗ',
